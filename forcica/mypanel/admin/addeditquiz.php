...
if(isset($_POST['submit']))
{
	...
	$studydoc=addslashes(trim($_POST['studydoc']));
	...
	if($_POST['eqid']!='')
	{
		...
		$lid=$_POST['eqid'];
		$lid1=$obj->updatelessonquiz($course_cat,$course,$title,$retake,$passing_grade,$duration,$studydoc,$lid, $sortno);
		
	}else{
		$lid=$obj->savelessonquiz($course_cat,$course,$title,$retake,$passing_grade,$duration,$studydoc, $sortno);
	}
...
<html lang="en">
  <head>
	...
	<script src="ckeditor/ckeditor.js"></script> 
	<script src="ckeditor/samples/ckeditor/sample.js"></script>
            ...
            <div class="span12">
              <div class="widget">
                 ...
                 <div class="widget-body">
                    ...
                    <div class="control-group span6 left-0">
                      ...
                      <div class="controls">
                        ...
                        <div class="control-group span6 left-0" style="display:none;">
                      <label class="control-label" for="password5">No of Retake Quiz*</label>
                      <div class="controls">
                        <input type="text" name="retake" id="retake" class="span12" placeholder="Enter retake quiz" value="<?php if($flag){ echo $data_les['retake'];}?>" onkeypress="return isNumberKey(event)">
                      </div>
                    </div>
                    <div class="control-group span6 left-0">
                      <label class="control-label" for="password5">Passing Grade*</label>
                      <div class="controls">
                        <input type="text" name="passing_grade" id="passing_grade" class="span12" placeholder="Enter Passing Grade" value="<?php if($flag){ echo $data_les['passing_grade'];}?>" onkeypress="return isNumberKey(event)">
                    ...
                    <div class="control-group span6 left-0">
                      ...
                      <div class="controls">
                         <input type="text" name="duration" id="duration" class="span12" value="<?php if($flag){ echo $data_les['duration'];}?>" placeholder="Quiz Time Duration" onkeypress="return isNumberKey(event)">
					...
					<div class="control-group span6 left-0">
                      ...
                      <div class="controls">
                         <input type="text" name="sortno" id="sortno" class="span12" value="<?php if($flag){ echo $data_les['sortId'];}?>" placeholder="Enter Sort Number" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.which == 8">
                    ...
                    <div class="control-group span12 left-0">
                      ...
                      <div class="controls">
					   <textarea id="bodymessage" name="studydoc" class="validate[required] span12" rows="5" style="resize:none;"><?php if($flag){ echo $data_les['study_doc'];}?></textarea> 
				...
				<div class="control-group span12 left-0">
                      ...
                      <div class="controls">
                         <input type="text" name="question_1" id="question_1" class="span12" value="" placeholder="Enter Question">
                      </div>
                </div>
				...
				<div id="addmore">
				 ...
				 <div class="row-fluid">
                    ...
                    <div class="form-actions no-margin">
                        ...
                        <input type="submit" name="submit" class="btn btn-info pull-right" value="Submit" onclick="return saveQuiz();">
                      <div class="clearfix">
                      </div>
                    </div>
 ...
 function saveQuiz()
    {
        ...
        var quiz_title=$("#title").val();
        var retake=$("#retake").val();
        var passing_grade=$("#passing_grade").val();
        var duration=$("#duration").val();
        var question_1=$("#question_1").val();
        var quizansoption_one1=$("#quizansoption_one1").val();
        var quizansoption_two1=$("#quizansoption_two1").val();
        var quizansoption_three1=$("#quizansoption_three1").val();
        var quizansoption_three1=$("#quizansoption_three1").val();
		
		
        if(category=='') {
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please select category.');
            setTimeout(function() {
            ...
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please select course.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
            }, 5000 );
            return false;
            ...
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please enter quiz title.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
            }, 5000 );
            return false;
            ...
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please enter no of retake quiz.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
            }, 5000 );
            return false;
        }
        else if(passing_grade=='') {
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please enter passing grade.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
            }, 5000 );
            return false;
            ...
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please enter quiz time duration.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
            }, 5000 );
            return false;
            ...
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please enter question.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
            }, 5000 );
            return false;
        }
        else if(quizansoption_one1=='') {
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please enter answer option.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
            }, 5000 );
            return false;
        }
        else if(quizansoption_two1=='') {
            $('#onetimeerror').fadeIn();
            $("#onetimeerror").html('Please enter answer option.');
            setTimeout(function() {
                $('#onetimeerror').fadeOut();
