...
if(isset($_POST['finalsubmit']))
{
    ...
    $res=$obj->saveFIdata('fi',$rowSD['tds']);
    
    if($res) {
        echo '<script type="text/javascript">alert("Details has been saved successfully"); window.location.href="filist.php";</script>';
    } else {
        echo '<script type="text/javascript">alert("Error occured while saving details"); window.location.href="filist.php";</script>';
    }
}
?>
<!DOCTYPE html>
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe098;"></span> Force Income
                  </div>
                    <div class="pull-right">
                        ...
                        <input type="button" name="checkprofit" id="checkprofit" class=" btn  btn-info" data-original-title="GO" data-toggle="tooltip" value="GO" onclick="getFILIST();" />
                    </div>
                </div>
...
<script>
        ...
        else
        {
            ...
            $.post("../ajax/ajax-pac.php",{
                ...
                if(ret[1]=='exist') {
                    $("#studentdetails").html('');
                    $('#onetimeerror').fadeIn();
                    $("#onetimeerror").html('FI of this month and year was already saved.');
                    setTimeout(function() {
                        $('#onetimeerror').fadeOut();
                    }, 5000 );
                } else {
    ...
    function saveFI()
    {
        ...
        {
            var r=confirm('Are you sure you want to save FI detail on selected month and year');
            if(r) 
            {
