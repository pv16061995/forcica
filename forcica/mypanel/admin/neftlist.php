            ...
            <div class="span12">
              <div class="widget no-margin">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon=""></span> NEFT List
                  </div>
                <div class="pull-right">
                    <select name="neftmonth" id="neftmonth">
                    ...
                    <select name="neftyear" id="neftyear">
                    ...
                    <a href="javascript:void(0);" class="btn btn-info " style="margin-bottom: 10px;" data-original-title="Go" onclick="searchNeftList();">Go</a>
...
<script>
    ...
    {
        var neftmonth=$("#neftmonth").val();
        var neftyear=$("#neftyear").val();
    ...
    function exportExcel()
    {
        ...
        {
            window.open('neftexcel.php?neftmonth='+neftmonth+'&neftyear='+neftyear+'','_blank');
        }
    }
    ...
    function validateemail()
    {
        ...
        {
            alert("Please generate neft excel first");
        }
        else 
        {
