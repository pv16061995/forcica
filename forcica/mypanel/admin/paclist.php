...
if(isset($_POST['finalsubmit']))
{
    ...
    $res=$obj->savePACdata('pac',$rowSD['tds']);
    
    if($res) {
        echo '<script type="text/javascript">alert("Details has been saved successfully"); window.location.href="paclist.php";</script>';
    } else {
        echo '<script type="text/javascript">alert("Error occured while saving details"); window.location.href="paclist.php";</script>';
    }
}
?>
<!DOCTYPE html>
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe098;"></span> Publicity Agent Commission
                  </div>
                </div>
                        ...
                        <div class="control-group span6 left-0">
                          <label class="control-label" for="email1">Select Date *</label>
                            <div class="controls">
                                ...
                                <input type="button" name="checkprofit" id="checkprofit" class="span3 btn btn-mini btn-info" data-original-title="GO" data-toggle="tooltip" value="GO" onclick="getPACLIST();" />
                            </div>
                        </div>
                    </div> 
        ...
        else
        {
            ...
            $.post("../ajax/ajax-pac.php",{
                ...
                if(ret[1]=='exist') {
                    $("#studentdetails").html('');
                    $('#onetimeerror').fadeIn();
                    $("#onetimeerror").html('PAC of selected date of this month and year was already saved.');
                    setTimeout(function() {
                        $('#onetimeerror').fadeOut();
                    }, 5000 );
                } else {
