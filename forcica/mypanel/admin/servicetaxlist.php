            ...
            <div class="span12">
              <div class="widget no-margin">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon=""></span> Service Tax List
                  </div>
                <div class="pull-right">
                    ...
                    <a href="javascript:void(0);" class="btn btn-info " style="margin-bottom: 10px;" data-original-title="Go" onclick="searchSTList();">Go</a>
                ...
                <div class="widget-body">
                  ...
                  <div id="dt_example" class="example_alt_pagination">
                    ...
                    <div class="clearfix"></div>
                    <div class="pull-right" id="taxcontent" style="display:none;"></div>
                    <div class="clearfix"></div>
                  </div>
                </div>
              </div>
...
<script>
    ...
    function searchSTList()
    {
        ...
        else if(styear=='')
        {
            ...
            $.post("../ajax/ajax-common.php",{
                ...
                $("#taxcontent").show('slow');
                $("#taxcontent").html("<h4>Total service tax for the month of "+ret[3]+" "+styear+" is - "+ret[2]+"</h4>");
            });
        }
    ...
    function exportExcel()
    {
        ...
        else if(styear=='')
        {
            ...
            window.open('stexcel.php?stmonth='+stmonth+'&styear='+styear+'','_blank');
        }
    }
    ...
    function validateemail()
    {
        ...
        {
            alert("Please generate service tax excel first");
        }
        else 
        {
