...
if(isset($_POST['submit3']))
{
    ...
    if($uploadflag)
    {
        ...
        $objM=new Member();
        $user_id=$objM->saveStudent($username,$password,$user_nicename,$user_email,$display_name,$pincode,1);
	  ...
	  $message .='</div>';
           ...
           /*  $message='<div style="width:500px; margin:auto; font-family:Helvetica,Arial; font-size:13px; color:#333; line-height:18px; background:#fafafa; border:#F1F0F0 solid 1px; padding:10px 10px 0 10px;">
			...
			$SMS= "Dear ".$name.", Thank you for your admission with forcica.com, Here is login your login details: Username :".trim($username)."  Password: ".$password." ";
			
			$obj->sendsms($phone1, $SMS);
        }
	...
	echo "<script> alert('Registration Details has been saved successfully.'); window.location.href='registration.php'; </script>";
...
.login_logo{
  ...
  <body>
	<header  class="main_header">
		...
		<div class="login_logo"><img src="<?php echo BASEPATH; ?>bootstrap/img/logo.png" style="height:60px;" class="login_logo_img"/>
		<!--<a href="index.php" class="logo"></a>--></div>
	</header>
    <div class="container-fluid">
      <?php // include_once('include/left-navigation.php'); ?>
    <div class="dashboard-wrapper no-margin" style="position:static;">
        ...
        <div class="main-container">
          ...
          <div class="page-header">
			...
			<div class="pull-right">
             <a href="index.php" class="btn btn-success" title="Click to login">Login here</a>
            </div>
                       ...
                       <div class="" id="thirdStep1" style="display:none;">
                            ...
                            <div class="row-fluid">
                                <div class="control-group span6 left-0">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="refno" id="refno" placeholder="Referral ENR No. / Self" class="span12" value="<?php if(isset($_POST['refno'])) echo $_POST['refno']; ?>">
                                    </div>
                                </div>
                                <div class="control-group span6 left-0">
