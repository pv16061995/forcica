...
<!--                <div class="nav-collapse collapse navbar-responsive-collapse">
          ...
          <div class="page-header">
            <div class="pull-left">
                <h2>Green Field Info</h2><br><br><br>
                <h4>ENR No. - <?php echo $enrno; ?> (<?php echo ucfirst($row['first_name']).' '.($row['last_name']); ?>)</h4>
            </div>
            ...
            <div class="span12">
              <div class="widget no-margin">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon=""></span> Green Field Info
                  </div>
                </div>
                    ...
                    <div class="tab-content no-margin">
                        ...
                        <div class="tab-pane" id="feedetails">
                            ...
                            <table id="data-table" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo ucfirst($rowFD['post_title']).' ('.$rowFD['categoryname'].')'; ?></td>
                        ...
                        <div class="tab-pane" id="uploads">
                            <?php
                            //$resUD=$obj->getStudentUploadDetails($user_id); 
                            ?>
                            <table id="data-table" class="table table-bordered table-striped">
                                <?php
//                                $i=1;
...
//                                {
                                ...
                                <tr>
                                    ...
                                    <td width="75%"><a href="../../images/userdocs/<?php echo $user_id; ?>/<?php echo $row['profile_image']; ?>" target="_blank"><?php echo $row['profile_image']; ?></a></td>
                                </tr>
                                <tr>
                                    <td width="25%">Uploaded Education Certificate</td>
                                    <td width="75%"><a href="../../images/userdocs/<?php echo $user_id; ?>/<?php echo $row['education_certificate']; ?>" target="_blank"><?php echo $row['education_certificate']; ?></a></td>
                                </tr>
                                <tr>
                                    <td width="25%">Uploaded address proof</td>
                                    <td width="75%"><a href="../../images/userdocs/<?php echo $user_id; ?>/<?php echo $row['address_proof']; ?>" target="_blank"><?php echo $row['address_proof']; ?></a></td>
                                </tr>
                                <?php //$i++; } ?>
                            </table>
                        </div>
                        ...
                        <div class="tab-pane" id="teamdetails">
                            ...
                            <input type="hidden" name="enrstr" id="enrstr" value="<?php echo $enrno; ?>">
                        </div>
