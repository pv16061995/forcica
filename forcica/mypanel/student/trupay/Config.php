<?php
 class Config {
	...
	public static $RET_URL_SUCC="http://10.0.0.66/forcica/mypanel/student/success.php";
	public static $RET_URL_FAIL="http://10.0.0.66/forcica/mypanel/student/failed.php";
